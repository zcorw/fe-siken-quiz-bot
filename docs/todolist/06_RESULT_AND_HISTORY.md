...
- [x] P0-RH-04 解析详情展示原题、全部选项、用户答案、正确答案、解説、出典 URL。
...
- [x] P0-RH-08 后端首次提交时更新 `user_question_stats`。
- [x] P0-RH-09 后端首次提交时更新 `user_topic_stats`。
- [x] P0-RH-10 重复访问已提交 token 时返回首次答案和结果。
- [x] P1-RH-11 移动端默认展示错题解析，提供 `すべての解説を表示` 展开全部。
- [x] P1-RH-12 PC 端不隐藏正确题，左侧按 1-20 原顺序展示全题列表。
